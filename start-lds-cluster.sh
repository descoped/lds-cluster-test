...
docker run --network=lds-cluster -it --name pulsar -p 6650:6650 -p 8080:8080 -v $PWD/data:/pulsar/data apachepulsar/pulsar:2.3.2 bin/pulsar standalone

docker run --network=lds-cluster -d --name neo4j-lds-cluster -p 7474:7474 -p 7687:7687 -e NEO4J_AUTH=neo4j/PasSW0rd neo4j:3.5.6
